...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/kronk
   cd kronk
   ```
...
```sh
https://github.com/flex-development/kronk/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/kronk/discussions/new?category=q-a
